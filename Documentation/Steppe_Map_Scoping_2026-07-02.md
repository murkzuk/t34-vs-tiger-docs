...
**Not yet done**: retest in the Level Editor with the byte-fix applied - this is the very next step. Extending `generate_mission.py`/`roster.json` to target this template instead of/alongside `Mission1` hasn't been started.
